...
chunk_flag = 1; %% 1-> chunking, 0-> no chunking
...
if chunk_flag
    ...
    % --- No chunking: run once over the full list ---
    flag = 0;
    [I1, V1, V1_expected, I2, V2, V2_expected, t, x_all, y_all, x_label, y_label] = smu_internal_sweep3_chunk( ...
        smu, Vgs_list, vDS, DS_comp, GS_comp, ...
